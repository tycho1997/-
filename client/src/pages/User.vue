<template>
    <div class="user">
        ...
        <div v-if="!!user_info.user_id" class="container">
            ...
            <div class="banner" v-for="item in ReadingArticleList" v-bind:key="item ? item._id : ''" @click="toReadingArticle(item)">
                <div class="reading">
            ...
            <div class="banner" v-for="item in MusicArticleList" v-bind:key="item ? item._id : ''" @click="toMusicArticle(item)">
                <div class="music">
            ...
            <div class="banner" v-for="item in FilmArticleList" v-bind:key="item ? item._id : ''" @click="toFilmArticle(item)">
                <div class="film">
            ...
            <div class="banner" v-for="item in SoundArticleList" v-bind:key="item ? item._id : ''" @click="toSoundArticle(item)">
                <div class="sound">
        ...
        <div v-else class="container">
            ...
            <div class="my-reader">
                <div class="sub">Reader</div>
                <div class="noReader" v-if="!ImageArticleList.length">
                    TA还没有Reader~
                </div>
