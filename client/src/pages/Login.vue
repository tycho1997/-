<template>
  <div class="login">
    ...
    <div class="btn" :class="{active: btnActive}" @click="handleLogin">登录</div>
    <div class="tips">
...
export default {
  ...
  watch: {
    email(val) {
      this.btnActive =
        this.$v.isEmail(val) && this.$v.password(this.password) ? true : false;
    },
    password(val) {
      this.btnActive =
        this.$v.password(val) && this.$v.isEmail(this.email) ? true : false;
    }
  },
  computed: {
    ...mapGetters([
