module.exports = {
    code(info) {
        ...
        <div class="header"
            style=" margin: 0px 30px; padding: 0px; height: 70px; text-align: center; line-height: 70px; color: white; font-size: 20px; font-weight: bold; background-color: rgb(7, 44, 97); border-top-left-radius: 10px; border-top-right-radius: 10px ; ; ; ; ">
            Reader
        </div>
        <div class="content"
            style=" margin: 0px 30px; padding: 0px; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px ; ; ; ; ">
            <h1
                style="margin: 0px; padding: 0px; font-size: 16px; text-align: center; color: rgb(51, 51, 51); line-height: 66px; text-align: center; font-weight: 500;">
                您好，请确认您在Reader的注册邮箱
            </h1>
            <hr
                style="margin: 0px 30px 20px; padding: 0px; border-style: solid; border-color: rgb(153, 153, 153); border-image: initial;">
            ...
            <div class="third" style="margin: 0px 30px 20px; padding: 0px;">
                ...
                <span class="verify-code"
                    style="margin: 0px; padding: 0px; color: rgb(0, 160, 233); font-weight: bold; font-size: 18px;">
                    ${info.code}
                </span>
                <span style="margin: 0px; padding: 0px; color: rgb(51, 51, 51); font-weight: bold;">
                    &nbsp;（不区分大小写）
            ...
            <div class="company" style="margin: 40px 30px 20px; padding: 0px;">
                <span class="companyName"
                    style="margin: 0px 20px 0px 0px; padding: 0px; font-size: 14px; color: rgb(51, 51, 51);">
                    Reader
                </span>
