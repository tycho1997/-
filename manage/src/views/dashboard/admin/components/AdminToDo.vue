<template>
  <div>
    <el-col :span="span">
      <el-card shadow="hover" class="admin-to-do">
        <div class="header">
          ...
          <div class="plus" @click.prevent="openAddToDoItemDialog">
    ...
    <div class="addToDoItemDialog">
      <el-dialog
        title="添加新的待办事项"
        :visible.sync="addToDoItemDialog.opened"
        :width="addToDoItemDialog.width"
      >
        <el-input
          placeholder="请输入..."
...
export default {
  ...
  data() {
    return {
      toDoList:
        window.localStorage.getItem("todo") === null
          ? []
