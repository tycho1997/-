...
export default {
                ...
                if (this.type === 'SoundArticle'){
                    window.mePlayer({
                        music : {
                            ...
                            cover : `http://mafei.ostqa.cn/default_av.jpg`,
                            // lrc   : '歌词字符串：[00:24.600]温柔的晚风\n[00:27.830]轻轻吹过 爱人的梦中\n ...'
                        },
    ...
    methods: {
        ...
        upqiniu (data) {
            ...
            if (data.file.type.indexOf('mp3') === -1 && data.file.type.indexOf('mpeg') === -1){
                this.$message({
                ...
                if (parseInt(this.readFileSize(data.file)) > 30){
                    ...
                    this.axios.getUploadToken().then((res) => {
                        ...
                        const key = `reader${Date.now()}${Math.floor(Math.random() * 100)}.${data.file.type.split('/')[1]}`
                        const putExtra = {
                            fname: "",
                            params: {},
                            mimeType: null
                        ...
                        const subscription = observable.subscribe({
                            ...
                            complete(res){
                                ...
                                self.postForm.sound_url = `http://mafei.ostqa.cn/${res.key}`
