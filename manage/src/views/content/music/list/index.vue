      ...
      <el-table-column label="操作" width="100">
        <template slot-scope="scope">
          <el-button
            ...
            plain
            circle
            @click="editPost(scope.$index, musicArticleList.docs)"
          >
          ...
          <el-button
            ...
            plain
            circle
            @click="deletePost(scope.$index, musicArticleList.docs)"
          ></el-button>
          <el-button
            size="mini"
            ...
            type="primary"
            plain
            @click="toHandleStatus(scope.$index, musicArticleList.docs, 4)"
          >待发布</el-button>
          <el-button
            size="mini"
          ...
          >
            ...
            <el-dropdown-menu slot="dropdown">
              <el-dropdown-item>
                <span @click="toHandleStatus(scope.$index, musicArticleList.docs, 2)">审核通过</span>
              </el-dropdown-item>
              <el-dropdown-item>
                <span @click="toHandleStatus(scope.$index, musicArticleList.docs, 3)">审核失败</span>
              </el-dropdown-item>
            </el-dropdown-menu>
          </el-dropdown>
          <el-button
            ...
            type="primary"
            plain
            @click="toHandleStatus(scope.$index, musicArticleList.docs, 1)"
          >发布审核</el-button>
...
export default {
  ...
  methods: {
    ...
    deletePost(index, rows) {
      this.axios.deleteArticle('music', rows[index]._id).then(res => {
          this.$message({
            message: res.data.message,
            type: res.data.status ? "success" : "error"
          });
